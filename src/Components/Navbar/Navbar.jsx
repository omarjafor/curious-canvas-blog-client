                    ...
                    user?.email ?
                        ...
                        <div className='space-x-2 pt-3'>
                            <NavLink to='/register' className={({ isActive, isPending }) =>
                                isPending ? "pending" : isActive ? "text-green-300 text-xl font-bold underline outline-offset-8" : "font-bold text-white mt-3 text-lg"}>Register
                            </NavLink>
                            <NavLink to='/login' className={({ isActive, isPending }) =>
                                isPending ? "pending" : isActive ? "text-green-300 text-xl font-bold underline outline-offset-8" : "font-bold text-white mt-3 text-lg"}>Login
                            </NavLink>
                        </div>
                }
