...
const CommentCard = ({ com}) => {
    const { name, email, photo, comment } = com || {};
        ...
        <div className="max-w-2xl mx-auto">
            <div className="flex gap-3 bg-white border border-gray-300 rounded-xl overflow-hidden items-center justify-start">
                ...
                <div className="relative w-32 h-32 flex-shrink-0">
                    <img className="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" loading="lazy" src={photo} />
                </div>
