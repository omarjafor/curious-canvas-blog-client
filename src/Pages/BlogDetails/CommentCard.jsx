        ...
        <div className="max-w-2xl mx-auto">
            <div className="flex gap-3 bg-white border border-gray-300 rounded-xl overflow-hidden items-center justify-start">
                ...
                <div className="flex flex-col gap-2 py-2 pr-3">
                    ...
                    <p className="text-xl font-bold">USER NAME HERE</p>

                    <p className="text-gray-900">
                        Description of full comments here Description of full comments here Description of full comments here Description of full comments here
                    </p>
                    ...
                    <span className="flex items-center justify-start text-gray-500">
                        ...
                        <p className="text-blue-500">user email here</p>
                    </span>
                </div>
            </div>
        </div>
