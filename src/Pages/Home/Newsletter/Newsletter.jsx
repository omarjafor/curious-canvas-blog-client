...
const Newsletter = () => {
    ...
    return (
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
            <div
                className="relative isolate overflow-hidden bg-gradient-to-r from-rose-600 via-fuchsia-800 to-indigo-800 dark:from-gray-700 dark:via-gray-900 dark:to-black px-6 py-24 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
                ...
                <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-white">
                    Stay up-to-date about new blog and get updates about this website, Subscribe to Newsletter.
                </p>

                <form onSubmit={handleNewsletter} className="mx-auto mt-10 flex max-w-md gap-x-4">

                    <label htmlFor="email-address" className="sr-only">Email address</label>
                    <input id="email-address" name="email" type="email" autoComplete="email" required className="min-w-0 flex-auto rounded-md border bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6 placeholder:text-white" placeholder="Enter your email" />
