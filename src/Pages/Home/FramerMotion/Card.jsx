...
const Card = ({ item, selectedId, setSelectedId }) => {
    ...
    return (
        <motion.div className={`card relative rounded overflow-hidden shadow-lg flex flex-col transform transition-transform duration-500 hover:scale-105 ${selectedId === item.id ? 'card-selected' : ''
            }`}
            ...
            <div className="px-6 py-4 mb-auto bg-slate-100 dark:bg-gray-900 dark:text-white">
                <motion.h2
